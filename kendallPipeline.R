...
SE_AFE_Corr <- function(samp_dir, rho_REM = c("none", "0", "1", "0,1")[3], out_dir) {
  ...
  cat("DF-ify Done")
  # concatHIT <- readRDS("/projectnb/evolution/zwakefield/GTEx_dl/upsampleOut/concatAFE.RDS")
  # concatRmats <- readRDS("/projectnb/evolution/zwakefield/GTEx_dl/upsampleOut/concatSE.RDS")
  # finSE <- readRDS("/projectnb/evolution/zwakefield/GTEx_dl/upsampleOut/mergeSE.RDS")
  # finAFE <- readRDS("/projectnb/evolution/zwakefield/GTEx_dl/upsampleOut/mergeAFE.RDS")
  # dfPerSE <- readRDS("/projectnb/evolution/zwakefield/GTEx_dl/upsampleOut/dfPerSE.RDS")
  # # 
  if (rho_REM == "none") {
    r <- calcRho(dfPerSE)
  } else if (rho_REM == "0") {
